...
import { Search, Bell, Settings, User, LogOut, Sun, Moon, Command } from 'lucide-react';
      ...
      <div className="flex items-center gap-2 ml-6">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="btn-ghost flex items-center gap-3 px-3 py-2">
          ...
          <DropdownMenuContent align="end" className="dropdown-content w-56 bg-white">
