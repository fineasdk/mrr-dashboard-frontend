        ...
        <Alert>
          ...
          <AlertDescription>
            <div className="space-y-2">
              ...
              <p className="text-sm">
                Our system will automatically track your Partner earnings, app installations, 
                and transaction data across all stores under your Partner account. This provides 
                comprehensive revenue analytics for your Shopify Partner business.
              </p>
            </div>
          </AlertDescription>
        </Alert>
            ...
            <form onSubmit={onSubmit} noValidate className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({...formData, partner_access_token: e.target.value})}
                  placeholder="shpat_..."
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">Set up API access in your Shopify Partner Dashboard</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">Obtain your Partner Access Token and Organization ID</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">Provide your Partner API credentials in the form above</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">We'll verify your Partner API access</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">We'll sync your Partner revenue and app installation data</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">Access your Partner earnings dashboard with real data</p>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Alert>
          ...
          <AlertDescription>
            <div className="space-y-1">
              ...
              <p className="text-sm">
                Your Partner API credentials are encrypted and stored securely. We only access 
                the Partner data you authorize and never store sensitive payment information.
              </p>
            </div>
          </AlertDescription>
        </Alert>
